	...
	<div class="lav">
		<form action="" method="POST">
			<table>
				<tr>
					<td>
						<input class="lav" type="submit" name="search_student" value="Search a Student">
					</td>
				</tr>
				<tr>
					<td>
						<input class="lav" type="submit" name="edit_student" value="Edit a Student">
					</td>
				</tr>
				<tr>
					<td>
						<input class="lav" type="submit" name="add_student" value="Add New Student">
					</td>
				</tr>
				<tr>
					<td>
						<input class="lav" type="submit" name="delete_student" value="Delete a Student">
					</td>
				</tr>
			</table>
		</form>
